...
id: agent-history
name: Agent History
description: Query your local AI agent conversations - list recent chats, search by keyword, see files modified
icon: material-symbols:history
color: "#8B5CF6"

tags: [agent history, Cursor chats, Claude chats, ChatGPT history, conversations]
...
Find and search your AI agent conversation history.
